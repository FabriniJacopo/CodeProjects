...
This is an Android Application that use the competences of signal processing acquired in the other engineering courses.
The app records the voice of the user and after a Fourier Elaboration in order to extract the pitch frequency it should determine the gender of the user.
The application in its embrional form needs to be trained by voices of both genders, the value extracted by the training process are stored in a .txt file in the phone storage.
